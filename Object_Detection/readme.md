...
This repository contains code for object detection using the YOLOv3 algorithm, maintained by Subham Satapathy. YOLOv3 is a popular real-time object detection algorithm known for its speed and accuracy.
...
Subham Satapathy is a Software Engineer with over 6 years of professional experience specializing in cloud-scale distributed systems and AI automation. With a strong background in Python, PyTorch, and TensorFlow, he focuses on building high-performance pipelines and LLM-orchestrated workflows.

...
Subham is a Software Engineer with over 6 years of professional experience specializing in building cloud-scale distributed systems and machine learning pipelines. With deep expertise in Python, PyTorch, and TensorFlow, he focuses on developing high-performance architectures and production-grade AI automation. His background includes optimizing billion-scale workloads and implementing robust CI/CD and monitoring solutions.
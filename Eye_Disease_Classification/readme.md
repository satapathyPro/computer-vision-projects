...
## Maintainer
Subham Satapathy is a Software Engineer with over 6 years of professional experience building cloud-scale distributed systems and production observability. With expertise in Python and TensorFlow, he maintains this repository to demonstrate the application of deep learning architectures in medical imaging. His work focuses on building robust, scalable pipelines and implementing advanced computer vision techniques like Grad-CAM for model interpretability.
